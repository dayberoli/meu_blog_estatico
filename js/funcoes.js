...
function template() {
    return `
        ...
        <nav>
            ...
            <a href="login.html" id="usuarioAcao" title="Logue-se no site" data-acao="login"><img src="img/anonymous.png" alt="Faça login" referrerpolicy="no-referrer"><span>Login</span></a>
        </nav>
